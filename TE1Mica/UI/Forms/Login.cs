...
namespace TE1.UI.Forms
{
    public partial class Login : XtraForm
    {
        ...
        private class LocalizationLogin
        {
            ...
            public String 타이틀 => GetString(Items.타이틀);
            public String 로그인 => GetString(Items.로그인);
            public String 사용자명 => GetString(Items.사용자명);
            public String 비밀번호 => GetString(Items.비밀번호);
            public String 인증오류 => GetString(Items.인증오류);
            public String 취소 => Localization.취소.GetString();
        }
    }
}