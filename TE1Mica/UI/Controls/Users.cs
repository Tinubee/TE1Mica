...
namespace TE1.UI.Controls
{
    public partial class Users : XtraUserControl
    {
        ...
        private void 유저삭제_Click(object sender, ItemClickEventArgs e)
        {
            ...
            if (정보 == null) return;
            if (!Global.Confirm(this.FindForm(), $"[{정보.성명}] {번역.삭제확인}")) return;
        ...
        private class LocalizationUsers
        {
            ...
            public String 정보저장 => Localization.GetString(Items.정보저장);
            ...
            public String 유저삭제 => Localization.GetString(Items.유저삭제);
            public String 유저제거 => Localization.GetString(Items.유저제거);
            public String 유저저장 => Localization.저장.GetString();
        }
    }
}
