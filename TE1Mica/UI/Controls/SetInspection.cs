...
namespace TE1.UI.Controls
{
    public partial class SetInspection : XtraUserControl
    {
        ...
        public void Init()
        {
            ...
            this.col원점R.DisplayFormat.FormatString = "{0:#,0.0000}";//lobal.환경설정.결과표현;
            this.col원점X.DisplayFormat.FormatString = "{0:#,0.0000}";//lobal.환경설정.결과표현;
            this.col원점Y.DisplayFormat.FormatString = "{0:#,0.0000}";//Global.환경설정.결과표현;
            ...
            this.b도구설정.EditValue = 카메라구분.Cam01;
